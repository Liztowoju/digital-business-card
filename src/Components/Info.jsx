...
import Headshot from "../images/headshot-image.png";
...
export default function Info() {
  return (
    <header className="profile-area">
      ...
      <a href="pluginette.com" className="web-address">liztowoju.com</a>
      <div className="profile-area-contact">
        ...
        <a href="https://www.linkedin.com/in/h-elizabeth/" className="linkedin-contact"> 
